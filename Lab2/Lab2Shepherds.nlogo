...
to go
  ...
  [
    ...
    if count shepherds2-on neighbors >= surrounding and ((random 99) + 1 <= kill-chance)
    [
      die
    ]
  ]
  ...
  [
    ...
    if count shepherds1-on neighbors >= surrounding and ((random 99) + 1 <= kill-chance)
    [
      die
    ]
  ]
...
"" ""
PENS
"efficiency" 1 0 -10899396 true "" "if ticks mod 50 = 0  ;; since the calculations are expensive\n[\n  update-sheep-counts\n  calculate-herding-efficiency\n  plotxy ticks herding-efficiency\n]"
"pen-1" 1 0 -2674135 true "" "if ticks mod 50 = 0  ;; since the calculations are expensive\n[\n  update-sheep-counts\n  calculate-herding-efficiency\n  plotxy ticks red-herding-efficiency\n]"
"pen-2" 1 0 -13345367 true "" "if ticks mod 50 = 0  ;; since the calculations are expensive\n[\n  update-sheep-counts\n  calculate-herding-efficiency\n  plotxy ticks blue-herding-efficiency\n]"
